...
import psycopg2
import yaml
import v2.settings as st

PGHOST							= st.DICT["root"]["common"]["PGHOST"]
svmNuDefault					= st.DICT["root"]["common"]["svmNuDefault"]					
svmCost							= st.DICT["root"]["common"]["svmCost"]
offset							= st.DICT["root"]["common"]["offset"]				
limit							= st.DICT["root"]["common"]["limit"]				
cv								= st.DICT["root"]["common"]["cv"]				
dataminestocksViewName			= st.DICT["root"]["common"]["dataminestocksViewName"]			
startNu							= st.DICT["root"]["common"]["startNu"]			
initialStepNu					= st.DICT["root"]["common"]["initialStepNu"]		
isUseCache						= st.DICT["root"]["common"]["isUseCache"]
LSLIB							= st.DICT["root"]["common"]["LSLIB"]
dbnameConst						= st.DICT["root"]["common"]["dbnameConst"]
